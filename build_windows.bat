...
cd /d %~dp0
set QT_API=pyqt6
REM PyQt6 kullanilir; PyQt5/PySide paketleri build'e dahil edilmez.
python -m PyInstaller --noconfirm --clean --windowed --name SepsiCore ^
...
echo.
echo Build tamamlandi: dist\SepsiCore\SepsiCore.exe
